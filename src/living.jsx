    ...
    <div>
        ...
        <div className="item">
          <a href="https://rog.asus.com/me-en/articles/news/get-ahead-of-the-game-with-the-latest-rog-gaming-tech-from-gamescom-2024/">
            <img src="https://dlcdnrog.asus.com/rog/media/1724151926819.webp" alt="Gamescom 2024" />
            <p>Get ahead of the game with the latest ROG gaming tech from Gamescom 2024</p>
          </a>
        </div>
        <div className="item">
          <a href="https://rog.asus.com/me-en/articles/gaming-monitors/qd-oled-and-360hz-converge-in-the-rog-strix-oled-xg27acdng/">
            <img src="https://dlcdnrog.asus.com/rog/media/1723842167221.webp" alt="OLED XG27ACDNG" />
        ...
        <div className="item">
          <a href="https://rog.asus.com/me-en/articles/crosshair-motherboards/the-rog-crosshair-x870e-hero-sets-a-new-standard-for-high-end-gaming-prowess/">
            <img src="https://dlcdnrog.asus.com/rog/media/1723864904277.webp" alt="X870E Hero" />
            <p>The ROG Crosshair X870E Hero sets a new standard for high-end gaming prowess</p>
          </a>
        </div>
        <div className="item">
          <a href="https://rog.asus.com/me-en/articles/psus/the-rog-strix-platinum-psu-series-provides-unwavering-stability-for-your-demanding-rig/">
            <img src="https://dlcdnrog.asus.com/rog/media/1723518686811.webp" alt="PSU Series" />
            <p>The ROG Strix Platinum PSU series provides unwavering stability for your demanding rig</p>
          </a>
        </div>
        <div className="item">
          <a href="https://rog.asus.com/me-en/articles/gaming-headsets/wireless-freedom-in-esports-ready-cans-meet-the-rog-delta-ii-gaming-headset/">
            <img src="https://dlcdnrog.asus.com/rog/media/17231648226.webp" alt="Delta II Gaming Headset" />
            <p>Wireless freedom in esports-ready cans: Meet the ROG Delta II gaming headset</p>
          </a>
        </div>
      </div>
        </div>   
